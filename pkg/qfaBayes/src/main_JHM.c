...
int main_JHM(int *arga,int *argb,int *argc,double *OUT, char **HEADER,
  int *QFAIA,double *QFADyA,double *QFADxA,int *QFADNoORFA,
  int *QFANoTIMEA,int *QFAIB,double *QFADyB,double *QFADxB,
  int *QFADNoORFB,int *QFANoTIMEB,double *PRIORS,double *TUNING)/*ADD ADAPTIVE 1,0*/
{
  GetRNGstate();
...
/*ADD ADAPTIVE 1,0*/
  ...
  gibbsandMHloop_JHM(burn,1,data,para,priors,MH,tuning,adaptive,0,adaptive_phase,OUT,HEADER);/*ADD ADAPTIVE 1,0 tuning adaptive -MH*/
  gibbsandMHloop_JHM(iters,thin,data,para,priors,MH,tuning,adaptive,1,0,OUT,HEADER);/*ADD ADAPTIVE 1,0 tuning adaptive -MH*/
