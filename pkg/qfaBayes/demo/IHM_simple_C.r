...
SHM_output_a<-SHM_main(burn=1,iters=1,thin=1,CAPL=50,QFA.I=SHM_a$QFA.I,
  QFA.y=SHM_a$QFA.y,QFA.x=SHM_a$QFA.x,QFA.NoORF=SHM_a$QFA.NoORF,
  QFA.NoTIME=SHM_a$QFA.NoTIME,PRIORS=PRIORS,TUNING)

Screen_b<-unique(b$Screen.Name)
SHM_b<-SHM_postpro(a=b,Treat=27,Screen=Screen_b,MPlate=15)
SHM_output_b<-SHM_main(burn=1,iters=1,thin=1,CAPL=50,QFA.I=SHM_b$QFA.I,
  QFA.y=SHM_b$QFA.y,QFA.x=SHM_b$QFA.x,QFA.NoORF=SHM_b$QFA.NoORF,
  QFA.NoTIME=SHM_b$QFA.NoTIME,PRIORS=PRIORS,TUNING)
...
IHM_output=IHM_main(burn=1,iters=1,thin=1,QFA.IA=SHM_a$QFA.I,
  ...
  QFA.yB=SHM_b$QFA.yB,QFA.NoORFB=SHM_b$QFA.NoORF,PRIORS_IHM,TUNING_IHM)
